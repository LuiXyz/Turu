...
exports.smsg = (conn, m, hasParent) => {
     ...
     */
     m.reply = async (text, chatId, options) => {
        ...
        conn.reply(chatId ? chatId : m.chat, text, m, { contextInfo: { mentionedJid: conn.parseMention(text), externalAdReply: { title: 'Join Lah ngab', body: `Click Here!`, sourceUrl: 'https://chat.whatsapp.com/DdMbKYRxn5TCFrB9m10XnQ', thumbnail: data }}, options })
    }
